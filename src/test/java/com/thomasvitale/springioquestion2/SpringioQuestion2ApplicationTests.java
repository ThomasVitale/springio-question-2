package com.thomasvitale.springioquestion2;

import com.thomasvitale.springioquestion2.model.Answers;
import com.thomasvitale.springioquestion2.model.GameScore;
...
@SpringBootTest(classes = SpringioQuestion2Application.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@TestPropertySource(properties = "game.eventing.enabled=true")
@Testcontainers
public class SpringioQuestion2ApplicationTests {
    ...
    void whenAnswersSubmittedThenGameScoreReturned() throws InterruptedException {
        ...
        webTestClient
                ...
                .expectBody(GameScore.class).value(gameScore -> {
                    ...
                    assertThat(gameScore.level()).isEqualTo("springio-question-2");
